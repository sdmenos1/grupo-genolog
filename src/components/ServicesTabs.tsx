  ...
  return (
    <section ref={sectionRef} id="servicios" className="py-24 bg-brand-titanium border-b border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Grid: Left Column Sticky + Right Column Natural Page Scroll */}
        <div className="grid lg:grid-cols-12 gap-12 items-start relative">
          
          {/* LEFT COLUMN: STICKY PINNED (Stays fixed while scrolling main page) */}
          ...
          {/* RIGHT COLUMN: FLOWS WITH NATURAL MAIN PAGE SCROLL (NO INNER SCROLLBAR) */}

...
export default function Accreditations({ onOpenDownloadModal }: AccreditationsProps) {
  ...
  return (
    <section ref={sectionRef} id="acreditaciones" className="py-24 bg-brand-titanium relative border-b border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Card 1: MINEM PERÚ */}
          <div className="gsap-card bg-gradient-to-b from-slate-900/90 to-brand-steel/80 backdrop-blur-xl p-8 rounded-3xl border border-slate-700/60 relative overflow-hidden group hover:border-brand-gold/50 transition-all duration-500 shadow-[0_15px_35px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-white group-hover:text-brand-gold transition duration-300">Empresa Contratista Minera Registrada</h3>
                <p className="text-xs font-semibold text-brand-gold">Resolución Directoral N° 0288-2021-MINEM/DGM</p>
              </div>
            </div>

            <ul className="mt-6 space-y-3.5 text-xs text-slate-300 border-t border-slate-800 pt-5">
              <li className="flex items-start gap-3">
                <i className="fa-solid fa-circle-check text-brand-gold mt-0.5 text-sm"></i>

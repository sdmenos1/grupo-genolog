...
export default function WhatsAppWidget() {
  return (
    <a 
      ...
      className="print:hidden fixed bottom-6 left-6 z-40 bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 rounded-full shadow-2xl transition duration-300 flex items-center justify-center text-2xl group border border-emerald-400/50">
